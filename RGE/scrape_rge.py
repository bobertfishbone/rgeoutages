...
BASE_URL="http://ebiz1.rge.com/OutageReports/"
#BASE_URL="http://zvarde.com/OutageReports1/"
START_URL="RGE.html"
...
USERAGENT="rgeoutages/%s (http://beepboop.com; version %s)" % (GIT_MODTIME, GIT_VERSION)
